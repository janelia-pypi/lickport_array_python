...
#+NAME: repository-name :noweb yes
...
# MANIFEST.in is generated automatically from .ssot.org
# File edits may be overwritten!
include README.md
include LICENSE
#+END_SRC
...
# pyproject.toml is generated automatically from .ssot.org
# File edits may be overwritten!
[build-system]
requires = [
    "setuptools>=42",
...
# setup.cfg is generated automatically from .ssot.org
# File edits may be overwritten!
[metadata]
name = <<name>>
version = <<version>>
